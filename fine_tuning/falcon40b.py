...
def save_checkpoint(epoch, batch_idx, model, optimizer, scaler, losses, checkpoint_dir='checkpoints_falcon40b_4', local_rank=0, enable_logging=False, logger=None, max_checkpoints=5):
    """
...
def save_decoded_inputs(dataloader, tokenizer, num_samples=3, rank=0):
    ...
    output_dir = "./trained_falcon40b_4"
...
def main():
    ...
    try:
        ...
        latest_checkpoint_path = find_latest_checkpoint(checkpoint_dir='checkpoints_falcon40b_4', len_dataloader=len_dataloader)
        ...
        checkpoint_dir = 'checkpoints_falcon40b_4'
        os.makedirs(checkpoint_dir, exist_ok=True)
