...
def save_checkpoint(epoch, batch_idx, model, optimizer, scaler, losses, checkpoint_dir='checkpoints_mistral_5', local_rank=0, enable_logging=False, logger=None, max_checkpoints=5):
    """
...
def find_latest_checkpoint(checkpoint_dir='checkpoints_mistral_5', len_dataloader=None):
    """
...
def main():
    ...
    try:
        ...
        latest_checkpoint_path = find_latest_checkpoint(checkpoint_dir='checkpoints_mistral_5', len_dataloader=len_dataloader)
        ...
        checkpoint_dir = 'checkpoints_mistral_5'
        os.makedirs(checkpoint_dir, exist_ok=True)
