# This file adds the context from prompt_wikidata.csv to the dataset generated by OpenAI since it did not include the context in its output
# we need to fne tune the model with RAG capabilities
import pandas as pd
